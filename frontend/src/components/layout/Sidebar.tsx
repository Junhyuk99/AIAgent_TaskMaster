...
const navigation = [
  ...
  { nameKey: 'nav.agents', href: '/agents', icon: RobotIcon },
  { nameKey: 'nav.functions', href: '/functions', icon: FunctionIcon },
  { nameKey: 'nav.knowledge', href: '/knowledge', icon: BookIcon },
  { nameKey: 'nav.usageStats', href: '/usage', icon: ChartIcon },
  { nameKey: 'nav.llmSettings', href: '/settings/llm', icon: SettingsIcon },
];
